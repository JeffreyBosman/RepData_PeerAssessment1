...
![plot of chunk Avarage day pattern](figure/Avarage day pattern-1.png)
...
```
## Error in unloadNamespace("plyr"): namespace 'plyr' is imported by 'scales', 'ggplot2' so cannot be unloaded
```
...
![plot of chunk NewData histogram](figure/NewData histogram-1.png)
